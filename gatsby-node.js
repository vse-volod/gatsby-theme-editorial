...
exports.createPages = ({ graphql, actions }) => {
  const debug = Debug('gatsby-theme-editorial:createPages')
...
exports.onCreateWebpackConfig = ({ stage, loaders, plugins, actions }) => {
  const debug = Debug('gatsby-theme-editorial:onCreateWebpackConfig')
  ...
  actions.setWebpackConfig({
    module: {
      rules: [
        {
          test: /\.js$/,
          include: path.dirname(require.resolve('gatsby-theme-editorial')),
          use: [loaders.js()],
        },
      ],
    },
...
exports.onPreBootstrap = ({ store }) => {
  const debug = Debug('gatsby-theme-editorial:onPreBoostrap')
